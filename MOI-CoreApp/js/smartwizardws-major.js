$(document).ready(function() {
  ...
  var btnApprove = $('<button class="btn btn-ts" type="button" data-toggle="modal" data-target="#approveRequest"><i class="fa fa-check" aria-hidden="true"></i> Approve Request</button>').on('click', function() {
  ...
  var btnFreeze = $('<button class="btn btn-ts" data-toggle="modal" data-target="#Freeze" type="button"><i class="fa fa-hand-rock-o" aria-hidden="true"></i> Freeze</button>').on('click', function() {
    //alert('Finish Clicked');
  });
