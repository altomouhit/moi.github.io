$(document).ready(function() {
  ...
  var btnApprove = $('<button class="btn btn-ts" data-toggle="modal" data-target="#approveRequest" type="button" ><i class="fa fa-check" aria-hidden="true"></i> Approve Request</button>').on('click', function() {
