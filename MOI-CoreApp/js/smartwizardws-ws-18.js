$(document).ready(function() {
  ...
  var btnMorestudy = $('<button class="btn btn-ws" data-toggle="modal" data-target="#StudyMore" type="button"><i class="fa fa-list-ul" aria-hidden="true"></i> For More Study</button>').on('click', function() {
    //alert('Finish Clicked');
  });
