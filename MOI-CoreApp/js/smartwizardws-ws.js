$(document).ready(function() {
  ...
  var btnApprove = $('<button class="btn btn-ws" type="button" data-toggle="modal" data-target="#approveRequest" ><i class="fa fa-check" aria-hidden="true"></i> Approve Request</button>').on('click', function() {
