 ...
 function GIS() {
   ...
   if ((regexNumber.test(GIS_Tech_Northings)) && (regexNumber.test(GIS_Tech_Eastings)) || (GIS_Tech_Northings == "" && GIS_Tech_Eastings == "")) {
     ...
     if (!(regexNumber.test(GIS_Tech_Eastings))) {
       ...
       document.getElementById("Tech_Eastings").setCustomValidity('Please enter valid numbers');
     } else {
       document.getElementById("Tech_Northings").setCustomValidity('Please enter valid numbers');
 ...
 $(document).ready(function() {
   ...
   var cols = [
    ...
    { "mDataProp": "GISTech_Eastings",  sTitle: "شرقي", sType: "numeric" }, 
    { "mDataProp": "GISTech_Northingse", sTitle: "شمالي", sType: "numeric" }, 
    { "mDataProp": "Actions", sTitle: "الإجراء", sType: "string",
