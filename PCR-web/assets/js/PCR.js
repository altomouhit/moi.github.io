...
$(document).ready(function() {
	$('#callCategory').on('change', function() {
		...
		$('#callSubCategory').find('option').remove().end().append('<option value="1000">Please select</option>').val('1000').trigger('change');
	...
	$('#callSubCategory').on('change', function() {
		//alert($(this).find(":selected").val());
		$('#callType').find('option').remove().end().append('<option value="1000">Please select</option>').val('1000').trigger('change');
