! function() {
						...
						2 < e.childNodes.length && e.firstElementChild.setAttribute("aria-expanded", "false"),
							e.querySelectorAll("*[id]").forEach(function(e) {
								e.classList.remove("show"),
									2 < e.childNodes.length && e.querySelectorAll("ul li a").forEach(function(e) {
	...
	function f() {
		"vertical" == document.documentElement.getAttribute("data-layout") && (document.getElementById("two-column-menu").innerHTML = "", 
	...
	function p(e) {
		if (e.target && e.target.matches("a.nav-link span"))
			if (0 == y(e.target.parentElement.nextElementSibling)) e.target.parentElement.nextElementSibling.classList.add("dropdown-custom-right"),
		...
		if (e.target && e.target.matches("a.nav-link"))
			if (0 == y(e.target.nextElementSibling)) e.target.nextElementSibling.classList.add("dropdown-custom-right"),
		...
		document.addEventListener("DOMContentLoaded", function() {
			...
			document.addEventListener("scroll", function() {
				...
				e = document.getElementById("page-topbar"),
					50 <= document.body.scrollTop || 50 <= document.documentElement.scrollTop ? e.classList.add("topbar-shadow") : e.classList.remove("topbar-shadow")
			}),
		...
		e && e.forEach(function(n) {
			! function e() {
				var t = +n.getAttribute("data-target"),
					...
					o = t / 250;
				o < 1 && (o = 1),
					a < t ? (n.innerText = (a + o).toFixed(0), setTimeout(e, 1)) : n.innerText = s(t),
					s(n.innerText)
			}()
		})
	}
		...
		if (e == e) {
			switch (e["data-layout"]) {
				...
				case "twocolumn":
					...
					break;
				default:
					"vertical" == sessionStorage.getItem("data-layout") && sessionStorage.getItem("data-layout") ? (z("data-layout", "vertical"), sessionStorage.setItem("data-layout", "vertical"), document.documentElement.setAttribute("data-layout", "vertical"), A("vertical"), g()) : 
					"horizontal" == sessionStorage.getItem("data-layout") ? (z("data-layout", "horizontal"), sessionStorage.setItem("data-layout", "horizontal"), document.documentElement.setAttribute("data-layout", "horizontal"), A("horizontal")) : "twocolumn" == sessionStorage.getItem("data-layout") && (z("data-layout", "twocolumn"), sessionStorage.setItem("data-layout", "twocolumn"), document.documentElement.setAttribute("data-layout", "twocolumn"), A("twocolumn"))
			}
	...
	sessionStorage.getItem("defaultAttribute") ? ((a = {})["data-layout"] = sessionStorage.getItem("data-layout"), a["data-sidebar-size"] = sessionStorage.getItem("data-sidebar-size"), a["data-layout-mode"] = sessionStorage.getItem("data-layout-mode"), a["data-layout-width"] = sessionStorage.getItem("data-layout-width"), a["data-sidebar"] = sessionStorage.getItem("data-sidebar"), a["data-layout-position"] = sessionStorage.getItem("data-layout-position"), a["data-layout-style"] = sessionStorage.getItem("data-layout-style"), a["data-topbar"] = sessionStorage.getItem("data-topbar"), B(a)) : (e = document.documentElement.attributes, a = {}, e.forEach(function(e) {
		...
		s = document.getElementsByTagName("HTML")[0], (e = document.querySelectorAll(".light-dark-mode")) && e.length && e[0].addEventListener("click", function(e) {
...
//     $('.road').delay(350).fadeOut('slow'); // fade out the white DIV that covers the website.
//     $('body').delay(350).css({
//         'overflow': 'hide'
//     });
// });
