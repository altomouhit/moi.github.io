...
// Major data
var major_data = [
	{ id: 1001, name: 'Landscape works', count: 5 }, 
	{ id: 1002, name: 'Demolition Permit', count: 2 }, 
	{ id: 1003, name: 'Mount Cutting Permit', count: 4 }, 
	{ id: 1004, name: 'Car Parking Shed', count: 1 }, 
	{ id: 1005, name: 'Advertisement Board', count: 3 },

	{ id: 1006, name: 'Land leveling', count: 5 }, 
	{ id: 1007, name: 'Placement sign Board', count: 2 }, 
	{ id: 1008, name: 'interlocking tiles(Title)', count: 4 }, 
	{ id: 1009, name: 'Temporary labor accommodation', count: 1 }
];
var major_permits = [
	{ id: 1001, name: 'Existing Building Characterization', count: 5 }
];
...
$.each(major_permits, function() {
	$('#Major_sub').append('<div class="form-group row"> \
     <label for="choice-' + this.id + '" class="col col-form-label">' + this.name + '</label> \
     <div class="col" style="padding:0;"><input type="text" class="form-control form-control-sm" readonly data-choice="' + this.id + '"' + 'data-choice-name="' + this.name + '" id="choice-' + this.id + '" value="' + this.count + '" /></div> \
     '
   	);
});
drawHBarChart('#chart1', major_data, CHART1_PARAMS);
drawHBarChart('#chart2', major_permits, CHART2_PARAMS);
