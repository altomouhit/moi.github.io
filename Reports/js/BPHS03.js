...
var CHART3_PARAMS = {
	//labelWidth: 3,
	colors: ['#008080','#36b5f5','#ac4154', '#43baf3'],
};
// Municipal License data
var vehicle_data = [
	{ id: 1001, name: 'New', count: 5 }, 
	{ id: 1002, name: 'Renew', count: 2 }, 
	{ id: 1003, name: 'Cancel', count: 4 }
];
var peddler_data = [
	{ id: 1001, name: 'New', count: 5 }, 
	{ id: 1002, name: 'Renew', count: 2 }, 
...
$('form').on('change', 'input', function() {
	...
	drawHBarChart('#chart3', result, CHART2_PARAMS);
});
$.each(vehicle_data, function() {
...
$.each(peddler_data, function() {
	$('#peddlerLicense').append('<div class="form-group row"> \
     <label for="choice-' + this.id + '" class="col col-form-label">' + this.name + '</label> \
     <div class="col" style="padding:0;"><input type="text" class="form-control form-control-sm" readonly data-choice="' + this.id + '"' + 'data-choice-name="' + this.name + '" id="choice-' + this.id + '" value="' + this.count + '" /></div> \
     '
   	);
});
$.each(drinking_data, function() {
	$('#drinkingLicense').append('<div class="form-group row"> \
     <label for="choice-' + this.id + '" class="col col-form-label">' + this.name + '</label> \
     <div class="col" style="padding:0;"><input type="text" class="form-control form-control-sm" readonly data-choice="' + this.id + '"' + 'data-choice-name="' + this.name + '" id="choice-' + this.id + '" value="' + this.count + '" /></div> \
     '
   	);
});
drawHBarChart('#chart1', vehicle_data, CHART1_PARAMS);
drawHBarChart('#chart2', peddler_data, CHART2_PARAMS);
drawHBarChart('#chart3', drinking_data, CHART3_PARAMS);
