! function(a) {
	...
	function t() {
		var e, t;
		e = a(".full-screen"), t = o.height(), e.css("min-height", t), e = a("header").height(), t = a(".screen-height"), e = o.height() - e, t.css("height", e)
	}
	a.scrollIt({
		upKey: 38,
		downKey: 40,
		...
		mobile: !1,
		live: !0
	}).init(), a(".parallax,.bg-img").each(function(e) {
		...
		a(".second, .third, .four").fadeOut(), a(".first").fadeIn(1e3)
	}), a(".tab2").click(function() {
		a(".first, .third, .four").fadeOut(), a(".second").fadeIn(1e3)
	}), a(".tab3").click(function() {
		a(".second, .first, .four").fadeOut(), a(".third").fadeIn(1e3)
	}), a(".tab4").click(function() {
		a(".first, .second, .third").fadeOut(), a(".four").fadeIn(1e3)
	}), o.resize(function(e) {
		setTimeout(function() {
			t()
		}, 500), e.preventDefault()
	}), t(), a(document).ready(function() {
		a("#testmonials-carousel").owlCarousel({
			loop: !0,
			responsiveClass: !0,
			autoplay: !0,
			smartSpeed: 800,
		...
		}), a(".app_screenshots_slides").owlCarousel({
			items: 1,
			loop: !0,
			autoplay: !0,
			smartSpeed: 800,
		...
		}), a(".testmonial-style02").owlCarousel({
			loop: !0,
			responsiveClass: !0,
			autoplay: !0,
			smartSpeed: 800,
		...
		}), a(".testmonial-style03").owlCarousel({
			loop: !0,
			responsiveClass: !0,
			autoplay: !0,
			smartSpeed: 800,
		...
		}), a(".testmonial-style05").owlCarousel({
			loop: !0,
			responsiveClass: !0,
			autoplay: !0,
			smartSpeed: 800,
		...
		}), a(".testmonial-style07").owlCarousel({
			loop: !0,
			responsiveClass: !0,
			autoplay: !0,
			smartSpeed: 900,
		...
		}), a(".testmonial-style08 .owl-carousel").owlCarousel({
			loop: !0,
			responsiveClass: !0,
			autoplay: !1,
			smartSpeed: 800,
		...
		}), a(".testimonial-style09 .owl-carousel").owlCarousel({
			loop: !0,
			responsiveClass: !0,
			autoplay: !0,
			smartSpeed: 800,
		...
		}), a(".testimonial-style10 .owl-carousel").owlCarousel({
			loop: !0,
			responsiveClass: !0,
			autoplay: !0,
			smartSpeed: 800,
		...
		}), a(".testimonial-style11 .owl-carousel").owlCarousel({
			loop: !0,
			responsiveClass: !0,
			autoplay: !0,
			smartSpeed: 800,
		...
		}), a(".course-category .owl-carousel").owlCarousel({
			loop: !0,
			responsiveClass: !0,
			autoplay: !0,
			smartSpeed: 800,
			...
			activate: function(e) {
				var t = a(this),
					s = a("#nested-tabInfo");
				a("span", s).text(t.text()), s.show()
			}
		}), 0 !== a(".childverticaltab").length && a(".childverticaltab").easyResponsiveTabs({
			type: "vertical",
			width: "auto",
			fit: !0,
			tabidentify: "ver_1",
		...
		}), 0 !== a(".verticaltab").length && a(".verticaltab").easyResponsiveTabs({
			type: "vertical",
			width: "auto",
			fit: !0,
			closed: "accordion",
			...
			date: "01 April 2025 00:01:00",
			format: "on"
		}), a(".slow-redirect a[href^='#']").click(function(e) {
			e.preventDefault();
			e = a(a(this).attr("href")).offset().top - 85;
			a("body, html").animate({
				scrollTop: e
			}, 1e3)
		}), a(".current-year").text((new Date).getFullYear())
	}), o.on("load", function() {
		var t = a(".portfolio-gallery-isotope").isotope({});
