		...
		function e(t, e) {
			if (t) {
				var a, o = s.getAttribute("href").split("/"),
					n = o[o.length - 1];
				a = "dark" == t ? "moaf-webapp-dark.css" : "moaf-webapp.css", a = s.getAttribute("href").replace(n, a), s.setAttribute("href", a), localStorage.setItem("mode", t), "dark" == t ? (i.classList.add("text-warning"), i.setAttribute("data-mode", "light")) : (i.classList.remove("text-warning"), i.setAttribute("data-mode", "dark")), document.getElementById("header-main") && function(t) {
