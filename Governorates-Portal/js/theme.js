...
(function(theme, $) {
    ...
    PluginReadMore.defaults = {
        buttonOpenLabel: 'Read More <i class="fal fa-chevron-down text-2 ms-1"></i>',
        buttonCloseLabel: 'Read Less <i class="fal fa-chevron-up text-2 ms-1"></i>',
        enableToggle: true,
        maxHeight: 110,
        overlayColor: '#FFF',
        overlayHeight: 100,
        ...
        Nav: {
            ...
            events: function() {
                ...
                if ($html.hasClass('side-header-hamburguer-sidebar')) {
                    $header.find('.dropdown-toggle, .dropdown-submenu > a').append('<i class="fal fa-chevron-down fa-chevron-right"></i>');
                } else {
                    $header.find('.dropdown-toggle, .dropdown-submenu > a').append('<i class="fal fa-chevron-down"></i>');
                }
