...
$(document).ready(function() {
  ...
  var btnFinish = $('<button></button>').text('Save as Draft').addClass('btn btn-hs').on('click', function() {
    //alert('Finish Clicked');
  });
  var btnSubmit = $('<button id="submitButton" onclick="submitpage()" style="display:none;margin-left:10px;"></button>').text('Submit').addClass('btn btn-hs').on('click', function() {
    $("#loader").show();
    $("#loader-wrapper").show();
  });
  // Smart Wizard
