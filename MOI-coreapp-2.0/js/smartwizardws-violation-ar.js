$(document).ready(function() {
  ...
  var btnSubmitViolation = $('<button class="btn btn-ts btn-violation-submit" data-bs-toggle="modal" data-bs-target="#violationSubmit" type="button"> تسليم <span class="fa fa-arrow-circle-left"></span></button>');
