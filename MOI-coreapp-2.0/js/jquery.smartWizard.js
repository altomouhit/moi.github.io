(function($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function() {
            ...
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button class="btn btn-ts sw-btn-next"><span class="fa fa-chevron-right"></span> Next</button>').attr('type', 'button') : null;
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button class="btn btn-ts sw-btn-prev"><span class="fa fa-chevron-left"></span> Previous</button>').attr('type', 'button') : null;
            var btnGroup = $('<div></div>').addClass('btn-group1 navbar-btn sw-btn-group pull-' + this.options.toolbarSettings.toolbarButtonPosition).attr('role', 'group').append(btnPrevious, btnNext);
            // Add extra toolbar buttons
            var btnGroupExtra = null;
            if (this.options.toolbarSettings.toolbarExtraButtons && this.options.toolbarSettings.toolbarExtraButtons.length > 0) {
                btnGroupExtra = $('<div></div>').addClass('btn-group1 navbar-btn sw-btn-group-extra pull-left' + this.options.toolbarSettings.toolbarButtonPosition).attr('role', 'group');
