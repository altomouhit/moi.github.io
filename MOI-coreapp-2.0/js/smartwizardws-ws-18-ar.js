$(document).ready(function() {
  ...
  var btnMorestudy = $('<button class="btn btn-ws" data-bs-toggle="modal" data-bs-target="#StudyMore" type="button"><i class="fa fa-list-ul" aria-hidden="true"></i> لمزيد من الدراسة</button>').on('click', function() {
    //alert('Finish Clicked');
  });
