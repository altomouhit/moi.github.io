$(document).ready(function() {
  ...
  var btnApprove = $('<button class="btn btn-ts" data-bs-toggle="modal" data-bs-target="#approveRequest" type="button" ><i class="fa fa-check" aria-hidden="true"></i> Approve Request</button>').on('click', function() {
  ...
  var btnsetsitevisit = $('<button class="btn btn-ts" data-bs-toggle="modal" data-bs-target="#ScheduleSiteVisit" type="button"><span class="fa fa-calendar"></span> Schedule Site Visit</button>').on('click', function() {
    //alert('Finish Clicked');
  }) 
