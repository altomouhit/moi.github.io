(function($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function() {
            ...
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button class="btn btn-ts sw-btn-next"><span class="fa fa-chevron-left"></span> التالى</button>').attr('type', 'button') : null;
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button class="btn btn-ts sw-btn-prev"><span class="fa fa-chevron-right"></span> السابق</button>').attr('type', 'button') : null;
