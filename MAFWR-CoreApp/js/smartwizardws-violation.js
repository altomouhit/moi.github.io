$(document).ready(function() {
  ...
  var btnsetsitevisit = $('<button class="btn btn-ts" data-toggle="modal" data-target="#ScheduleSiteVisit" type="button"><span class="fa fa-calendar"></span> Schedule Site Visit / Interview</button>').on('click', function() {
    //alert('Finish Clicked');
  }) 
  ...
  var btnFreeze = $('<button class="btn btn-ts" id="Freezeid"  data-toggle="modal" data-target="#Freeze" type="button"><i class="fa fa-hand-rock-o" aria-hidden="true"></i> Hold</button>').on('click', function() {
    //alert('Finish Clicked');
  });
  var btnUnFreeze = $('<button class="btn btn-ts" id="UnFreezeid" data-toggle="modal" data-target="#UnFreeze" type="button"><i class="fa fa-hand-rock-o" aria-hidden="true"></i> Resume</button>').on('click', function() {
    //alert('Finish Clicked');
  });
  var btnStudy = $('<button class="btn btn-ts" id="Studyid" data-toggle="modal" data-target="#Tostudy" type="button"><span class="fa fa-arrow-circle-right"></span>To Study</button>').on('click', function() {
    //alert('Finish Clicked');
  });
  var btnlegal = $('<button class="btn btn-ts" id="legalid" data-toggle="modal" data-target="#Tolegal" type="button"></span> To Legal Reseacher</button>').on('click', function() {
    //alert('Finish Clicked');
  });
  var btnStaff = $('<button class="btn btn-ts" id="Staffid" data-toggle="modal" data-target="#ToStaff" type="button"><span class="fa fa-arrow-circle-right"></span> To Legal Staff</button>').on('click', function() {
    //alert('Finish Clicked');
  });
