$(document).ready(function() {
  ...
  var btnNext = $('<button class="btn btn-ws" data-toggle="modal" data-target="#nextRequest" type="button"><i class="fa fa-chevron-left" aria-hidden="true"></i> أرسال للمستوى التالى </button>').on('click', function() {
    //alert('Finish Clicked');
  });
  
  var btnReturn = $('<button class="btn btn-ws" data-toggle="modal" data-target="#returnSite" type="button"><i class="fa fa-clock-o" aria-hidden="true"></i> عودة للمراجعة</button>').on('click', function() {
    //alert('Finish Clicked');
  });
  var btnsetsitevisit = $('<button class="btn btn-ws" data-toggle="modal" data-target="#ScheduleSiteVisit" type="button"><span class="fa fa-calendar"></span> جدولة زيارة الموقع</button>').on('click', function() {
    //alert('Finish Clicked');
  }) 
  var btnClarifications = $('<button data-toggle="modal" data-target="#requestClarifications" type="button" class="btn btn-ws"><span class="fa fa-pencil-square-o"></span> طلب توضيحات</button>').on('click', function() {
    //alert('Finish Clicked');
  });
  var btnReassign = $('<button class="btn btn-ws" data-toggle="modal" data-target="#reAssign" type="button"><i class="fa fa-exchange" aria-hidden="true"></i> إعادة تعيين</button>').on('click', function() {
    //alert('Finish Clicked');
  });
  var btnStudy = $('<button class="btn btn-ws" data-toggle="modal" data-target="#StudyMore" type="button"><i class="fa fa-list-ul" aria-hidden="true"></i> المزيد من الدراسة</button>').on('click', function() {
    //alert('Finish Clicked');
  });
  var btnAuthorized = $('<button class="btn btn-ws" data-toggle="modal" data-target="#Authorized" type="button"><i class="fa fa-check" aria-hidden="true"></i> مخول</button>').on('click', function() {
    //alert('Finish Clicked');
  });
